...
define([
    ...
    'text!drawingPCI/test/pciSampleA/data/likert_triple/qti.xml'
     ...
     */
    pciTestProvider.addManifestPath('pciSampleA', 'drawingPCI/pciCreator/pciSampleA/pciCreator.json');
    ...
    QUnit.test('renders correctly', function (assert) {
        ...
        parseXml(likertTripleXml).then(function (itemData) {
            var assetManager = getAssetManager('/drawingPCI/views/js/test/pciSampleA/data/likert_triple/');
